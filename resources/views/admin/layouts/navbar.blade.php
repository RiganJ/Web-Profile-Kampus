<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row default-layout-navbar">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      <a class="navbar-brand brand-logo" href="{{ url('/admin') }}"><img src="{{ asset('images/logoufdk.png') }}" alt="logo"/></a>
    ...
    <div class="navbar-menu-wrapper d-flex align-items-stretch">
      ...
      <ul class="navbar-nav">
        <li class="nav-item nav-search d-none d-md-flex">
          <div class="nav-link">
            <div class="font-weight-semibold text-dark">Dashboard Admin UFDK</div>
            <small class="text-muted">Kelola konten, data kampus, dan aktivitas admin dari satu tempat</small>
          </div>
        </li>
      </ul>
