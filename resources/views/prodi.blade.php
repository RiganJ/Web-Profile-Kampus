...
<section class="hero-modern relative flex items-center h-[520px] overflow-hidden">
  ...
  <div class="absolute inset-0">
    <img src="/images/banner-prodi.jpg" alt="Program Studi" class="w-full h-full object-cover">
    <div class="absolute inset-0 bg-gradient-to-b from-[rgba(3,10,30,.65)] to-[rgba(3,10,30,.75)]"></div>
    <div class="absolute inset-0 bg-[url('/images/pattern2.jpg')] bg-repeat bg-[size:300px] opacity-10 pointer-events-none"></div>
  </div>
