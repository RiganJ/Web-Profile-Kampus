...
<header id="navbar" class="fixed top-0 left-0 w-full z-50 transition-all duration-500 transform nav-gradient">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex h-20 items-center gap-4">
            ...
            <nav class="mx-auto hidden min-w-0 items-center justify-center gap-3 text-sm font-medium text-white xl:flex 2xl:gap-5">
                <a href="/" class="nav-link flex items-center gap-2"><i data-lucide="home" class="w-4 h-4"></i>{{ __('ui.home') }}</a>
                <div class="dropdown relative group">
                    ...
                    <div class="dropdown-menu absolute left-0 mt-2 w-60 bg-white text-gray-700 rounded-xl shadow-lg opacity-0 invisible translate-y-3 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-200">
                        <a href="/sejarah" class="dropdown-item flex items-center gap-2"><i data-lucide="book" class="w-4 h-4"></i>{{ __('ui.history') }}</a>
            ...
            <div class="hidden shrink-0 items-center gap-2 xl:flex 2xl:gap-3">
                <a href="{{ route('language.switch', app()->getLocale() === 'id' ? 'en' : 'id') }}" class="language-switch inline-flex h-10 items-center gap-2 rounded-full px-4 text-xs font-semibold transition">
                    <i data-lucide="languages" class="h-4 w-4"></i>
                    {{ __('ui.lang_switch_to') }}
                </a>
                <a href="https://pmb.ufdk.ac.id" target="_blank" rel="noopener noreferrer" class="group relative flex h-12 min-w-[150px] items-center justify-between overflow-hidden rounded-full bg-white/20 px-5 text-slate-800 backdrop-blur-md 2xl:h-14 2xl:min-w-[176px] 2xl:px-6">
            ...
            <div class="mx-auto flex max-w-3xl flex-col gap-3 p-4 font-medium text-slate-700 sm:p-5">
                <div class="mobile-section">
                    ...
                    <div class="grid grid-cols-2 gap-1">
                        <a href="/" class="mobile-nav-link"><i data-lucide="home"></i>{{ __('ui.home') }}</a>
                        <a href="/sejarah" class="mobile-nav-link"><i data-lucide="building-2"></i>{{ __('ui.profile') }}</a>
                        <a href="/prodi" class="mobile-nav-link"><i data-lucide="graduation-cap"></i>{{ __('ui.academic') }}</a>
                        <a href="{{ route('pusat-informasi.index') }}" class="mobile-nav-link"><i data-lucide="circle-help"></i>{{ __('ui.information_center') }}</a>
                ...
                <div class="mobile-section">
                    <p class="mobile-section-title"><i data-lucide="landmark"></i>Fakultas</p>
                    <div class="grid gap-1 sm:grid-cols-2">
                        <a href="{{ route('faculty.show', 'kesehatan', false) }}" class="mobile-nav-link text-sm"><i data-lucide="heart-pulse"></i>Fakultas Ilmu Kesehatan</a>
                        <a href="{{ route('faculty.show', 'sosial-ekonomi-humaniora', false) }}" class="mobile-nav-link text-sm"><i data-lucide="briefcase-business"></i>Fakultas Sosial, Ekonomi &amp; Humaniora</a>
                    </div>
                </div>

                <div class="mobile-section">
                    <p class="mobile-section-title"><i data-lucide="grid-2x2"></i>Portal &amp; Layanan</p>
