...
class HeroSlideController extends Controller
{
    ...
    public function index()
    {
        ...
        $slides = HeroSlide::orderByDesc('sort_order')
            ->latest()
            ->get();
    ...
    private function syncPublicStorageCopy(
        string $sourcePath,
        string $storagePath
    ): void
    {
    ...
    ): void
    {
        ...
        $this->deletePublicStorageCopy($storagePath);
    ...
    private function deletePublicStorageCopy(
        ?string $storagePath
    ): void
    {
